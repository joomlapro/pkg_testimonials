...
$canOrder  = $user->authorise('core.edit.state', 'com_testimonials.testimonial');
$archived  = $this->state->get('filter.published') == 2 ? true : false;
$trashed   = $this->state->get('filter.published') == -2 ? true : false;
$saveOrder = $listOrder == 'fp.ordering';
?>
<form action="<?php echo JRoute::_('index.php?option=com_testimonials&view=featured'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped" id="testimonialList">
			...
			<tbody>
				...
				<?php foreach ($this->items as $i => $item):
					...
					$assetId    = 'com_testimonials.testimonial.' . $item->id;
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<td class="nowrap has-context">
							<div class="pull-left">
								...
								<?php endif; ?>
								<?php if ($canEdit): ?>
									<a href="<?php echo JRoute::_('index.php?option=com_testimonials&task=testimonial.edit&return=featured&id=' . $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>"><?php echo $this->escape($item->name); ?></a>
								<?php else: ?>
							...
							<div class="pull-left">
								<?php
									...
									JHtml::_('dropdown.edit', $item->id, 'testimonial.', 'index.php?option=com_testimonials&return=featured');
