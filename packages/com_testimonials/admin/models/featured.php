 ...
 * @since       3.1
 */
class TestimonialsModelFeatured extends TestimonialsModelTestimonials
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery($resolveFKs = true)
	{
		...
		$query->from('#__testimonials AS a');
		...
		$query->select('fp.ordering')
			->join('INNER', '#__testimonials_frontpage AS fp ON fp.testimonial_id = a.id');
